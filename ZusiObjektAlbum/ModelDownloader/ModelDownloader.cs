...
namespace ZusiObjektAlbum.ModelDownloader
{
  ...
  public static class ModelDownloader
  {
    ...
    private static HttpClient CreateHttpClient()
    {
      ...
      // GitHub lehnt Requests ohne User-Agent ab (äußert sich oft als
      // 404 statt 403) - Browser senden den automatisch mit, HttpClient nicht.
      client.DefaultRequestHeaders.UserAgent.ParseAdd("ZusiObjektAlbum/1.0");
      return client;
    }
